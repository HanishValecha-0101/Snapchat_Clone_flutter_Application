...
//target: LatLng(11.5760029, 104.845914),
  ...
  Widget getFooter() {
    return Padding(
      padding: const EdgeInsets.only(left: 30, top: 60), child: Column(
...
// ),
// child:
                    Image.asset("assets/bitmoji.png",width: 10,height:
                    ),
                  ),
                ),
              ),
...
// final GoogleMapController controller = await _controller.future; // controller.animateCamera(CameraUpdate.newCameraPosition(_kLake)); // }
  Widget getBody() {
    return GoogleMap(
